...
/**
 * Declares that a Java type should be represented by an Avro arrayschema. May
 * be used for base classes or interfaces whose instantiable subclasses can be
 * listed in the parameters to the @Array annotation. If applied to method
...
public @interface Array {
  /** The instantiable classes that compose this array of unions. */
  Class[] value();
}
